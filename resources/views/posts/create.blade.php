...
<div class="w-full flex flex-col items-center justify-center bg-slate-300 ">
    ...
    @auth
    <form action="{{ route('posts') }}" method="post" class="w-full h-fit mb-4 bg-white p-6 mb-32 rounded-lg sm:w-10/12 md:mb-0">
        @csrf
        <div class="mb-4">
            ...
            <div class="w-full block md:flex items-center">
                ...
                <input type="text" name="type" id="type" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('type') border-red-500 @enderror" placeholder="Write a title"/></label>
                ...
                <input type="text" name="link" id="link" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('link') border-red-500 @enderror" placeholder="Write something!"/></label>
            ...
            <input type="text" name="image" id="image" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('image') border-red-500 @enderror" placeholder="Just link!" value="https://cdn.pixabay.com/photo/2022/04/03/22/05/buildings-7109918_960_720.jpg"/></label>
